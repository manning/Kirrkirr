...
public class CrosswordGenerator {
    ...
    private final static int MAXWORDS   = 20;
    private final static int MAX_BOARD_WORDS = MAXWORDS-1;
    public final static int MATSIZE_X    = 20;
    public final static int MATSIZE_Y    = 9;//also change other constants
    ...
    {
        Vector<CrosswordInfo> usedWords = new Vector<>();
